...
class AlmacenesController extends Controller
{
    ...
    public function get_historial_responsables(Request $request)
    {
        ...
        $result = AlmacenesService::get_historial_responsables((int) $id_almacen);
    ...
    public function nuevo_responsable(Request $request)
    {
        ...
        $result = AlmacenesService::nuevo_responsable(
            $request->id_almacen,
            $request->id_empleado,
    ...
    public function get_empleados(Request $request)
    {
        ...
        $result = AlmacenesService::get_empleados((int) $id_almacen);
    ...
    public function get_minas_abastecidas(Request $request)
    {
        ...
        $result = AlmacenesService::get_minas_abastecidas((int) $id_almacen);
    ...
    public function nueva_mina_por_abastecer(Request $request)
    {
        ...
        $result = AlmacenesService::nueva_mina_por_abastecer(
            $request->id_almacen,
            $request->id_mina
        );
    ...
    public function eliminar_abastecimiento_mina(Request $request)
    {
        ...
        $result = AlmacenesService::eliminar_abastecimiento_mina($id_almacen_mina);
    ...
    public function get_minas(Request $request)
    {
        ...
        $result = AlmacenesService::get_minas((int) $id_almacen);
