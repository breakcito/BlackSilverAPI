...
class SolicitudesService
{
    ...
    {
        $data = SolicitudesData::get_detalles_solicitud($id_solicitud);
    ...
    {
        return ApiResponse::success(SolicitudesData::get_productos());
    }
    ...
    {
        return ApiResponse::success(SolicitudesData::get_almacenes($id_empleado));
    }

    // Listar unidades de medida.
    public function get_unidades_medida()
    {
        return ApiResponse::success(SolicitudesData::get_unidades_medida());
    }
}
